...
export default function Wizard(props) {
  const { nodes, materials } = useGLTF('/models/elf_wizard (1).glb')

  const modelRef = useRef()
  
  useFrame((state, delta, xrFrame) => {
    modelRef.current.position.y = -1.5 + Math.sin(state.clock.elapsedTime)*0.17;
  })
  ...
  return (
    ...
    ref={modelRef}
        ...
        rotation={[0.20,-0.2,0]}
    >
      <group name="5ee58d3d1c1c4921b58c16de8781249bfbx" scale={0.01}>
        <group
          name="locator_staf"
...
useGLTF.preload('/models/elf_wizard (1).glb')